        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="nav-collapse">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="riwayat_kerja.php">Riwayat Kerja</a>
                    </li>
        ...
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                    <div class="card w-100" style="border-radius: 2rem;">
                        ...
                        <h3><i class="fas fa-chalkboard-teacher mr-2"></i> Tambah Riwayat Kerja</h3>
                        <hr>
                        <form action="simpan_kerja.php" method="post">
                            <div class="form-row">
