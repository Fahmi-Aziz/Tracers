        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="nav-collapse">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="akun_alumni.php">Akun Alumni</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="export_riwayat_kerja">Export Riwayat Kerja</a>
                    </li>
        ...
        <div class="container-sm rounded-1 w-100 bg-white" style="border-radius: 3rem;">
            <div class="row">
                <div class="col-md-12 p-5 pt-1">
                    <h4><i class="fas fa-user-graduate mr-2"></i> Akun Alumni</h4>
                    <hr>
                    <a href="#" class="btn btn-primary mb-2" data-toggle="modal" data-target="#tambahmhs">
                        <i class="fas fa-plus-circle mr-2"></i>Tambah Akun Alumni</a>
                    <div class="table-responsive my-3">
                        <table id="example" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                $query = mysqli_query($koneksi, "SELECT * FROM user WHERE role = 'alumni'");
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <h5 align="center">Apakah anda yakin ingin menghapus akun dengan
                                                            User ID
                                                            <?php echo $data['user_id']; ?>?
                                                        </h5>
                                                    </div>
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="hapus_akun.php?user_id=<?php echo $data['user_id']; ?>"
                                        ...
                                        <div class="modal fade" id="editmhs<?php echo $data['user_id']; ?>" role="dialog">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form
                                                            action="update_akun.php?user_id=<?php echo $data['user_id']; ?>"
            ...
            <div id="tambahmhs" class="modal fade" role="dialog" style="display:none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="akun_alumni.php" method="post" role="form">
                                <div class="form-group">
                                    <div class="row">
                                        <label class="col-sm-3 control-label text-left">Username
                                            :</label>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <label class="col-sm-3 control-label text-left">Role
                                            :</label>
                                        <div class="col-sm-8">
