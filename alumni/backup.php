            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                <div class="card w-100" style="border-radius: 2rem;">
                    <div class="card-body p-3" >
                        ...
                        $query1 = mysqli_query($koneksi, "SELECT * FROM kuisioner_alumni WHERE user_id = '$alumni_user_id'");
                        ...
                        $query2 = mysqli_query($koneksi, "SELECT * FROM kuisioner_alumni WHERE user_id = '$alumni_user_id' AND bersekolah IS NULL AND ketenagakerjaan IS  NULL");
                        ...
                        $query3 = mysqli_query($koneksi, "SELECT * FROM kuisioner_alumni WHERE user_id = '$alumni_user_id' AND bersekolah IS NOT NULL AND ketenagakerjaan IS  NULL");
                        ...
                        ?>
                        <input type="hidden" name="email" value="<?php echo $query['nama']; ?>">
