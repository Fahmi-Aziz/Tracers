            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                <div class="card w-100" style="border-radius: 2rem;">
                    <div class="card-body p-3">
                        ...
                        $query = mysqli_query($koneksi, "SELECT * FROM kuisioner_perusahaan WHERE user_id = '$perusahaan_user_id'");
                        $query1 = mysqli_query($koneksi, "SELECT * FROM kuisioner_perusahaan WHERE user_id = '$perusahaan_user_id' AND nama_alumni IS NULL AND posisi IS NULL AND pertanyaan1 IS  NULL AND pertanyaan2 IS NULL AND pertanyaan3 IS NULL AND pertanyaan6 IS  NULL AND pertanyaan7 IS NULL AND pertanyaan8 IS NULL AND pertanyaan11 IS  NULL AND pertanyaan12 IS NULL AND pertanyaan13 IS NULL AND pertanyaan16 IS  NULL AND pertanyaan17 IS NULL AND pertanyaan18 IS NULL AND pertanyaan19 IS NULL AND pertanyaan20 IS NULL");

                        if (mysqli_num_rows($query) == 0) {
                            echo "<center>Para perusahaan yang terhormat, saat ini kami sedang mengadakan Tracer Study kepada perusahaan Polibatam.<br></center>";
                ...
                <a href="perusahaan.php" class="btn btn-md w-100 bg-white">Home</a>
            </div>
            <div class="my-4"></div>
                            <?php
                        }
