            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                    <div class="card w-100" style="border-radius: 2rem;">
                        ...
                        <h5 class="card-title">
                            ...
                            <h3><i class="fas fa-chalkboard-teacher mr-2"></i> Edit Data Perusahaan</h3>
                            <hr>
                            <form action="update_perusahaan.php" method="post">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6 mb-3">
                                        <label>Email</label>
                                        <input type="text" name="email" class="form-control" id="email" value="<?php echo $data1['email']; ?>">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6 mb-3">
                                    ...
                                    <div class="form-group col-md-6 mb-3">
                                        <label>Alamat</label>
                                        <input type="text" name="alamat" class="form-control" id="alamat" value="<?php echo $data1['alamat']; ?>">
                                    </div>
                                </div>
                                <hr>
