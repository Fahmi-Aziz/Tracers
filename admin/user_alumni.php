        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="nav-collapse">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="user_alumni.php">User Alumni</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container-sm rounded-1 w-100 bg-white" style="border-radius: 3rem;">
            <div class="row">
                <div class="col-md-12 p-5 pt-1">
                    <h4><i class="fas fa-user-graduate mr-2"></i> Daftar Alumni</h4>
                    <hr>
                    <a href="#" class="btn btn-primary mb-2" data-toggle="modal" data-target="#tambahalumni">
                        <i class="fas fa-plus-circle mr-2"></i>Tambah Data Alumni</a>
                    <div class="table-responsive my-3">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="update_alumni.php?user_id=<?php echo $data['user_id']; ?>"
                                                method="post" role="form">
                                                <?php
                                                $user_id = $data['user_id'];
                                                $query1 = mysqli_query($koneksi, "SELECT * FROM alumni WHERE user_id='$user_id'");
                                                while ($data1 = mysqli_fetch_assoc($query1)) {
                                                    ?>
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <label class="col-sm-3 control-label text-left">NIM
                                                                :</label>
                                                            <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <label class="col-sm-3 control-label text-left">Prodi
                                                                :</label>
                                                            <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <label class="col-sm-3 control-label text-left">No
                                                                Telepon :</label>
                                                            <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <label class="col-sm-3 control-label text-left">Jenis
                                                                Kelamin :</label>
                                                            <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <label class="col-sm-3 control-label text-left">IPK
                                                                :</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" name="ipk" class="form-control"
                                                                    value="<?php echo $data1['ipk']; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="hapus_alumni.php?user_id=<?php echo $data['user_id']; ?>"
                        ...
                        <!-- Lihat Modal -->
                        <div class="modal fade" id="lihatmhs<?php echo $data['user_id']; ?>" tabindex="-1" role="dialog"
                            aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLongTitle">Data Pribadi Alumni</h5>
            ...
            <div class="modal-dialog modal-lg width-50">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <h3 class="modal-title mx-auto">Tambah Data Alumni</h3>
                    </div>
                    <div class="modal-body">
                        <form action="tambah_data_alumni.php" method="post" role="form">
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-sm-3 control-label text-left">ID User :</label>
                                    <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-sm-3 control-label text-left">Prodi :</label>
                                    <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-sm-3 control-label text-left">IPK :</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="ipk" class="form-control" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
