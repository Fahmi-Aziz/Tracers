...
<head>
    ...
    <title>Export Riwayat Kerja</title>
</head>
<script>
...
<body class="bg-light">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="nav-collapse">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="export_riwayat_kerja.php">Export Riwayat Kerja</a>
                    </li>
    ...
    <div class="container py-2 h-100  bg-light">
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                <div class="card w-100" style="border-radius: 1rem;">
                    <div class="card-body p-3">
                        <div class="card-header text-left">Hi admin!
                        </div>
                        <div class="card-body w-100">
                            <h5 class="card-title">&nbsp;</h5>
                            <p class="card-text"></p>
                            <div class="card-body w-100">
                                <h5 class="card-title">Export Riwayat Kerja</h5>
                                <p class="card-text"></p>
                            </div>
                            <div class="card-body w-100 text-right">
                                <a href="export_perusahaan.php" class="btn btn-primary text-center"
                                    style="width: 8rem;">Export</a>
                            </div>
                            <hr class="sm-1">
                            </hr>
                            <div class="text-left">
                                <p class="card-text"><small class="text-muted text-left">Made By Kelompok 4 </small></p>
                            </div>
                        </div>
                    </div>
                </div>
