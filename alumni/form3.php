            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                <div class="card w-100" style="border-radius: 2rem;">
                    <div class="card-body p-3">
                        <form action="simpan_form3.php" method="post">
                            <h3 class="card-title">Ketenagakerjaan</h3>
                            <hr class="lg-5">
                            <div class="form-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="bekerja" id="checkbox1"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="wirausaha" id="checkbox2"
                                        name="ketenagakerjaan[]">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="mencari kerja" id="checkbox3"
                                        name="ketenagakerjaan[]">
                                    <label class="form-check-label" for="checkbox3">
                                        <b>Sedang Mencari Pekerjaan</b>
                                    </label>
                                </div>
                            </div>
                            <hr>
